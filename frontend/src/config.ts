/**
 * SSID-EMS Frontend Configuration — Local Scaffold Only
...
export const ENV_MODE: string = "local_scaffold";
export const SERVICE_NAME: string = "SSID-EMS";
export const VERSION: string = "0.1.0-scaffold";
